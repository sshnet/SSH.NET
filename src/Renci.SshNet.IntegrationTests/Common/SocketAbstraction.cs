...
namespace Renci.SshNet.IntegrationTests.Common
{
    internal static class SocketAbstraction
    {
        ...
        {
            var sendReceiveToken = (IToken) e.UserToken;
        ...
        private class BlockingSendReceiveToken : IToken
        {
        ...
        private class PartialSendReceiveToken : IToken
        {
        ...
        private class ContinuousReceiveToken : IToken
        {
