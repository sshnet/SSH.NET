...
{
    [TestClass]
    public class ForwardedPortRemoteTest_Dispose_PortStarted_ChannelBound_Disconnect
    {
        ...
        protected void Arrange()
        {
            ...
            _sessionMock.Setup(p => p.SendMessage(It.IsAny<CancelTcpIpForwardGlobalRequestMessage>()))
                .Throws(new SshException("Client not connected."));
        }
