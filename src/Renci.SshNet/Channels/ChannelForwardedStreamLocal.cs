...
namespace Renci.SshNet.Channels
{
    ...
    internal class ChannelForwardedStreamLocal : ServerChannel, IChannelForwardedStreamLocal
    {
        ...
        public void Bind(EndPoint remoteEndpoint, IForwardedPort forwardedPort)
        {
            if (!IsConnected)
            {
            ...
            try
            {
                ...
                {
#endif
                    _socket = SocketAbstraction.Connect((IPEndPoint)remoteEndpoint, ConnectionInfo.Timeout);
#if FEATURE_UNIX_SOCKETS
                }
#endif
        ...
        /// <summary>
        /// Closes the socket, hereby interrupting the blocking receive in <see cref="Bind(EndPoint,IForwardedPort)"/>.
        /// </summary>
