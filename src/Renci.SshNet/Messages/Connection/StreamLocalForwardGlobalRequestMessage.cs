...
{
    internal class StreamLocalForwardGlobalRequestMessage : GlobalRequestMessage
    {
        private byte[] _socketPath;

        public StreamLocalForwardGlobalRequestMessage(string socketpath)
            : base(Ascii.GetBytes("streamlocal-forward@openssh.com"), true)
        {
