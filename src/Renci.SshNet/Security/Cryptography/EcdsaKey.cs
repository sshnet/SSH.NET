        ...
        public override BigInteger[] Public
        {
            ...
            set
            {
                ...
                using (var bw = new BinaryWriter(new MemoryStream(blob)))
                {
                    ...
                    bw.Write(cord_size);
                    bw.Write(value_1_x_bn.ToByteArray()); // q.x
                    bw.Write(value_1_y_bn.ToByteArray()); // q.y
                }
