...
namespace Renci.SshNet.V2
{
    ...
    public interface ISshClient : IBaseClient
    {
        ...
        /// <returns><see cref="ISshCommand"/> object which uses specified encoding.</returns>
        ...
        /// </summary>
        /// <param name="commandText">The command text.</param>
        /// <returns>Returns an instance of <see cref="ISshCommand"/> with execution results.</returns>
