    ...
    public class AesCipherTest : TestBase
    {
        ...
        public void AES_CTR_128_Length64_NoPad()
        {
            var input = new byte[]
            {
                ...
                0xa7, 0xd9, 0x03, 0x60, 0x04, 0xf1, 0x2a, 0x55, 0x3e, 0x27, 0x04, 0x5a, 0xad, 0x3e, 0x57, 0x65,
                0x0d, 0x83, 0xbb, 0xac, 0x0a, 0xf9, 0x64, 0xe2, 0x76, 0x7d, 0x50, 0x11, 0x5e, 0xad, 0xd7, 0x4d,
            };
            var key = new byte[]
            {
                0x42, 0xcc, 0xb3, 0x5a, 0x52, 0x0b, 0x2e, 0x52, 0x8c, 0xb5, 0x84, 0xb9, 0x1a, 0x1c, 0x59, 0xf9,
            };
            var iv = new byte[]
            {
                0xe1, 0x1c, 0xe0, 0x3b, 0x2c, 0xae, 0x39, 0xad, 0x74, 0x21, 0xea, 0x87, 0xa1, 0x18, 0xf6, 0x91,
            };

            // echo -n -e '' | openssl enc -e -aes-128-ctr -K 42CCB35A520B2E528CB584B91A1C59F9 -iv E11CE03B2CAE39AD7421EA87A118F691 -nopad | hd
            var expected = new byte[]
            {
                0xde, 0x96, 0xe5, 0x60, 0x42, 0xcf, 0xc3, 0x2d, 0x16, 0xe5, 0x63, 0x2c, 0xee, 0x12, 0x0a, 0xe2,
                0x10, 0x1b, 0xca, 0xc6, 0xbe, 0xe9, 0x89, 0x2a, 0xd4, 0x5c, 0x73, 0xdd, 0xf4, 0x88, 0xce, 0xe5,
                0x25, 0xe3, 0x26, 0x54, 0x67, 0x31, 0x74, 0x6e, 0x5f, 0x4a, 0x05, 0x51, 0xda, 0xeb, 0xb1, 0x69,
                0xaf, 0x36, 0x92, 0xb0, 0x21, 0x49, 0x35, 0xff, 0xbf, 0xcf, 0x06, 0xdd, 0x22, 0xba, 0xea, 0xe5,
            };
        ...
        public void AES_CTR_192_Length16_NoPad()
        {
            var input = new byte[]
            {
                0x50, 0xb7, 0x18, 0xe1, 0x8a, 0xfd, 0x13, 0x02, 0x54, 0x68, 0x20, 0x55, 0x75, 0xab, 0xc8, 0x5a,
            };
            var key = new byte[]
            {
                0x23, 0x57, 0x30, 0x42, 0xcc, 0x9c, 0x20, 0x94, 0x92, 0x06, 0xe6, 0x31, 0x21, 0xa6, 0xb1, 0x73,
                0xbf, 0xf2, 0x69, 0x63, 0x03, 0x78, 0x6e, 0xe4,
            };
            var iv = new byte[]
            {
                0x08, 0xde, 0xe6, 0xc3, 0x8d, 0xe4, 0x37, 0xc9, 0x58, 0x8f, 0x64, 0x4a, 0xe8, 0xb4, 0xc4, 0xb4,
            };

            // echo -n -e '\x50\xb7\x18\xe1\x8a\xfd\x13\x02\x54\x68\x20\x55\x75\xab\xc8\x5a' | openssl enc -e -aes-192-ctr -K 23573042CC9C20949206E63121A6B173BFF2696303786EE4 -iv 08DEE6C38DE437C9588F644AE8B4C4B4 -nopad | hd
            var expected = new byte[]
            {
                0x45, 0x5f, 0x3f, 0x9b, 0x2e, 0xe0, 0x2a, 0x60, 0x91, 0xd5, 0xe7, 0x8d, 0xf0, 0x24, 0x2d, 0x3a,
            };
        ...
        public void AES_CTR_192_Length64_NoPad()
        {
            var input = new byte[]
            {
                0x96, 0x84, 0x4e, 0x84, 0x16, 0xe1, 0xe1, 0xad, 0xb7, 0xac, 0x95, 0x82, 0x41, 0x65, 0x56, 0xab,
                0xe9, 0x4c, 0x39, 0xed, 0xb5, 0x5c, 0x06, 0xae, 0xce, 0x1d, 0xd8, 0x91, 0x42, 0x67, 0x8b, 0x0b,
                0x2e, 0xb5, 0xcd, 0x7f, 0x29, 0xe9, 0xcd, 0x26, 0xfd, 0x39, 0x0c, 0xe1, 0x4e, 0xb4, 0x87, 0xf3,
                0x39, 0xb9, 0x60, 0x9c, 0x7a, 0xd6, 0xfe, 0x39, 0x7d, 0xa0, 0xb6, 0xf9, 0x09, 0x4f, 0x6b, 0x50,
            };
            var key = new byte[]
            {
                0x20, 0x8a, 0x54, 0x8c, 0x97, 0xd6, 0x81, 0xff, 0x7e, 0x12, 0xf0, 0x7b, 0x50, 0x24, 0x5f, 0x19,
                0x95, 0xe5, 0x58, 0x89, 0x06, 0xef, 0x90, 0x57,
            };
            var iv = new byte[]
            {
                0xb6, 0x94, 0x02, 0x89, 0x32, 0xd4, 0x1d, 0xad, 0xce, 0xbc, 0xc0, 0xc4, 0x60, 0xfb, 0x5b, 0x62,
            };

            // echo -n -e '' | openssl enc -e -aes-192-ctr -K 208A548C97D681FF7E12F07B50245F1995E5588906EF9057 -iv B694028932D41DADCEBCC0C460FB5B62 -nopad | hd
            var expected = new byte[]
            {
                0xf4, 0x69, 0xa7, 0x4c, 0x08, 0xac, 0xea, 0x4f, 0x69, 0xb1, 0xa1, 0x51, 0x38, 0x00, 0x8c, 0x1c,
                0x40, 0x58, 0x53, 0xd4, 0x97, 0x3c, 0xba, 0x80, 0xdd, 0xe0, 0x2f, 0x46, 0xa4, 0x05, 0xa1, 0x7b,
                0xde, 0x93, 0x66, 0xd3, 0xdf, 0x61, 0x49, 0x5f, 0x82, 0x12, 0x76, 0x68, 0xd6, 0x0c, 0x89, 0x4b,
                0xc9, 0xd9, 0x5c, 0xc5, 0x6c, 0x37, 0x68, 0x9f, 0xc7, 0x41, 0x3d, 0xe9, 0xee, 0xa7, 0xff, 0x0c,
            };
        ...
        public void AES_CTR_256_Length16_NoPad()
        {
            var input = new byte[]
            {
                0x37, 0x61, 0x1d, 0x68, 0xe6, 0x82, 0xe8, 0x58, 0x41, 0x9d, 0x63, 0x23, 0xf7, 0xe1, 0x49, 0x31,
            };
            var key = new byte[]
            {
                0xfa, 0xfd, 0xd5, 0x03, 0xd4, 0xf8, 0xcd, 0xaa, 0xf4, 0x43, 0xad, 0x93, 0x64, 0x9b, 0xb8, 0x9a,
                0x89, 0xf6, 0x51, 0xa5, 0xd1, 0x28, 0x71, 0x34, 0xab, 0xa9, 0x47, 0x95, 0x70, 0xf9, 0xb5, 0xec,
            };
            var iv = new byte[]
            {
                0x72, 0x8f, 0xc9, 0x63, 0x26, 0x57, 0x8d, 0x3f, 0x94, 0x73, 0x73, 0xa3, 0xd5, 0x54, 0xf4, 0xa6,
            };

            // echo -n -e '\x37\x61\x1d\x68\xe6\x82\xe8\x58\x41\x9d\x63\x23\xf7\xe1\x49\x31' | openssl enc -e -aes-256-ctr -K FAFDD503D4F8CDAAF443AD93649BB89A89F651A5D1287134ABA9479570F9B5EC -iv 728FC96326578D3F947373A3D554F4A6 -nopad | hd
            var expected = new byte[]
            {
                0xe9, 0x0e, 0x8e, 0xe0, 0xff, 0xe1, 0xb3, 0x3d, 0x35, 0xa4, 0xd6, 0xeb, 0x05, 0x02, 0x32, 0x39,
            };
        ...
        public void AES_CTR_256_Length64_NoPad()
        {
            var input = new byte[]
            {
                0xe4, 0xc9, 0x9a, 0x01, 0x8f, 0xa4, 0x60, 0xd1, 0x8b, 0xa1, 0x58, 0x2b, 0xb0, 0x37, 0x39, 0xfa,
                0x8d, 0xc1, 0x21, 0xd5, 0xd1, 0x55, 0x74, 0x31, 0x68, 0x12, 0x10, 0x5d, 0xb4, 0xcd, 0x5e, 0x56,
                0xb5, 0xa1, 0xb1, 0xa6, 0x5f, 0xb4, 0x5c, 0xcd, 0x2e, 0xf8, 0xd7, 0x84, 0xff, 0x62, 0x8f, 0x5c,
                0x39, 0x78, 0x15, 0x14, 0x33, 0x1f, 0xd4, 0x8e, 0x55, 0x68, 0x98, 0x7d, 0x93, 0x02, 0x1d, 0xbe,
            };
            var key = new byte[]
            {
                0x42, 0x01, 0x75, 0x0e, 0x86, 0x92, 0x9a, 0xd8, 0x64, 0x53, 0xa6, 0xd9, 0x7e, 0xef, 0x32, 0x06,
                0x83, 0xb4, 0x23, 0x3b, 0xb8, 0x4a, 0x22, 0x96, 0xcc, 0x22, 0x51, 0xf7, 0x1b, 0xdf, 0x39, 0x2c,
            };
            var iv = new byte[]
            {
                0xdb, 0x19, 0x42, 0xfd, 0xec, 0x80, 0xd6, 0xa6, 0xdd, 0x3c, 0xaf, 0xdf, 0x78, 0xfb, 0x10, 0x66,
            };

            // echo -n -e '' | openssl enc -e -aes-256-ctr -K 4201750E86929AD86453A6D97EEF320683B4233BB84A2296CC2251F71BDF392C -iv DB1942FDEC80D6A6DD3CAFDF78FB1066 -nopad | hd
            var expected = new byte[]
            {
                0x79, 0x04, 0x3b, 0x20, 0xe1, 0xc0, 0x24, 0x0b, 0x96, 0xc1, 0xf3, 0xc8, 0xd8, 0xb0, 0xd6, 0x3b,
                0x88, 0x4f, 0xc6, 0x4b, 0x26, 0x55, 0xba, 0x87, 0xec, 0xc2, 0x41, 0x5f, 0xc1, 0x24, 0xdf, 0xc5,
                0xf5, 0x72, 0x10, 0xfe, 0xe7, 0xbe, 0x9d, 0x1f, 0x5c, 0x00, 0x3e, 0xbf, 0x51, 0x23, 0x40, 0x59,
                0x2e, 0xdd, 0xea, 0x50, 0x36, 0x94, 0xb4, 0x40, 0x28, 0x04, 0xbd, 0xc0, 0x4d, 0x48, 0xa1, 0x34,
            };
        ...
        public void AES_OFB_128_Length16_NoPad()
        {
            var input = new byte[]
            {
                0x35, 0x92, 0xf9, 0xdf, 0xde, 0xe1, 0x05, 0xf7, 0xdf, 0xdf, 0x41, 0x63, 0x41, 0xa3, 0xbd, 0x84,
            };
            var key = new byte[]
            {
                0x19, 0x7a, 0xfd, 0x64, 0xac, 0x35, 0x1a, 0x02, 0xdd, 0x7d, 0x5e, 0x7b, 0x9a, 0x42, 0x1d, 0xd0,
            };
            var iv = new byte[]
            {
                0x11, 0xea, 0xc2, 0x89, 0xe5, 0x5a, 0x4d, 0xf9, 0x13, 0x4b, 0x1e, 0x0c, 0x3e, 0x72, 0x65, 0x3a,
            };

            // echo -n -e '\x35\x92\xf9\xdf\xde\xe1\x05\xf7\xdf\xdf\x41\x63\x41\xa3\xbd\x84' | openssl enc -e -aes-128-ofb -K 197AFD64AC351A02DD7D5E7B9A421DD0 -iv 11EAC289E55A4DF9134B1E0C3E72653A -nopad | hd
            var expected = new byte[]
            {
                0x6d, 0xce, 0x96, 0xe5, 0x3c, 0x5a, 0xf3, 0xa5, 0x5b, 0x84, 0x89, 0x68, 0x00, 0xe7, 0xbf, 0x38,
            };
        ...
        public void AES_OFB_128_Length64_NoPad()
        {
            var input = new byte[]
            {
                0x7f, 0x2b, 0xc6, 0xfe, 0xfd, 0xac, 0xba, 0x00, 0x77, 0xf6, 0x01, 0x61, 0x83, 0x8a, 0x5c, 0x9c,
                0xc2, 0x70, 0x52, 0x56, 0xe1, 0x33, 0x9e, 0xbf, 0x2c, 0x04, 0x51, 0x61, 0x16, 0x0e, 0xc4, 0x6b,
                0x17, 0x23, 0xfb, 0x6f, 0x7c, 0x1e, 0xd2, 0x65, 0x30, 0xc1, 0x12, 0xee, 0x58, 0xec, 0x76, 0x89,
                0xee, 0x82, 0x49, 0xcd, 0x20, 0x0e, 0x59, 0x4b, 0x8c, 0x06, 0xd2, 0xf9, 0x5b, 0x58, 0xe9, 0x68,
            };
            var key = new byte[]
            {
                0x32, 0x96, 0x49, 0x5f, 0x8e, 0xec, 0x1f, 0xa3, 0x9e, 0xec, 0x26, 0x1f, 0x21, 0xb0, 0x66, 0x3f,
            };
            var iv = new byte[]
            {
                0x8d, 0xc8, 0x72, 0x94, 0xc4, 0xf6, 0x4a, 0x09, 0xc9, 0xb0, 0xe2, 0x76, 0x4c, 0xd8, 0x0a, 0xd7,
            };

            // echo -n -e '' | openssl enc -e -aes-128-ofb -K 3296495F8EEC1FA39EEC261F21B0663F -iv 8DC87294C4F64A09C9B0E2764CD80AD7 -nopad | hd
            var expected = new byte[]
            {
                0x32, 0x0f, 0x71, 0x49, 0xd1, 0x88, 0xe0, 0x5f, 0x34, 0x4c, 0xef, 0x70, 0x0f, 0xe7, 0x39, 0xd6,
                0x33, 0x7d, 0x77, 0xf3, 0x33, 0x20, 0x95, 0xf5, 0x16, 0x81, 0xa7, 0xf9, 0x36, 0xb3, 0xed, 0xf7,
                0x97, 0xbb, 0xc8, 0xdb, 0x00, 0x7e, 0xd5, 0x0a, 0xf9, 0x85, 0xa5, 0x84, 0x63, 0x16, 0xde, 0xf0,
                0x53, 0x19, 0xe7, 0x96, 0xc5, 0x4c, 0x6f, 0x76, 0xe4, 0x6e, 0x96, 0xdc, 0x4c, 0x8e, 0x8e, 0x74,
            };
        ...
        public void AES_OFB_192_Length16_NoPad()
        {
            var input = new byte[]
            {
                0xd7, 0xa9, 0xbc, 0xc2, 0xa2, 0x17, 0xfa, 0x02, 0x62, 0xa6, 0x2f, 0x33, 0xe7, 0x3a, 0x29, 0xdc,
            };
            var key = new byte[]
            {
                0x9f, 0x92, 0x6c, 0x93, 0xe6, 0x55, 0xa4, 0x3c, 0x4b, 0x3f, 0x96, 0xde, 0x0a, 0xa9, 0x57, 0xc5,
                0xe2, 0x4e, 0x47, 0x78, 0xf3, 0xa4, 0x9d, 0x76,
            };
            var iv = new byte[]
            {
                0xcd, 0x70, 0x31, 0x1e, 0xc6, 0x16, 0x21, 0x8f, 0x86, 0x06, 0xd6, 0xb9, 0x6c, 0x77, 0xf0, 0x82,
            };

            // echo -n -e '\xd7\xa9\xbc\xc2\xa2\x17\xfa\x02\x62\xa6\x2f\x33\xe7\x3a\x29\xdc' | openssl enc -e -aes-192-ofb -K 9F926C93E655A43C4B3F96DE0AA957C5E24E4778F3A49D76 -iv CD70311EC616218F8606D6B96C77F082 -nopad | hd
            var expected = new byte[]
            {
                0xa5, 0xfc, 0xcb, 0x1d, 0xca, 0xa0, 0x7d, 0x15, 0x4f, 0xe8, 0x17, 0x11, 0x8d, 0x95, 0x62, 0x81,
            };
        ...
        public void AES_OFB_192_Length64_NoPad()
        {
            var input = new byte[]
            {
                0x04, 0x7f, 0x77, 0x62, 0x80, 0x1c, 0xf7, 0xb9, 0x4f, 0x6a, 0x51, 0x99, 0xf2, 0xb1, 0xe8, 0xfb,
                0xf5, 0xf6, 0xc5, 0x76, 0x23, 0x86, 0x75, 0x34, 0x1e, 0x06, 0x57, 0x03, 0xd3, 0x9d, 0x58, 0x6b,
                0x5d, 0xc5, 0x73, 0x74, 0x2d, 0x3a, 0xf5, 0xb1, 0x78, 0x78, 0xcf, 0x5b, 0xc5, 0x88, 0x9c, 0xd5,
                0x1d, 0xda, 0xc4, 0x75, 0xb1, 0x7a, 0x5f, 0x7e, 0x0a, 0x42, 0x44, 0x79, 0xc4, 0xf3, 0xe6, 0xb1,
            };
            var key = new byte[]
            {
                0x11, 0xe6, 0x3b, 0x2d, 0x3d, 0x74, 0xce, 0xbb, 0x01, 0x14, 0xfe, 0xab, 0xb6, 0x19, 0x6f, 0x95,
                0x69, 0x82, 0xe6, 0xf8, 0xd9, 0xe3, 0xb9, 0xe3,
            };
            var iv = new byte[]
            {
                0x65, 0xf4, 0x69, 0xea, 0xf5, 0x7b, 0xec, 0x84, 0x91, 0x1d, 0x49, 0xde, 0x4d, 0x6f, 0x97, 0xa8,
            };

            // echo -n -e '' | openssl enc -e -aes-192-ofb -K 11E63B2D3D74CEBB0114FEABB6196F956982E6F8D9E3B9E3 -iv 65F469EAF57BEC84911D49DE4D6F97A8 -nopad | hd
            var expected = new byte[]
            {
                0x02, 0xbb, 0xeb, 0xcf, 0xfe, 0x1d, 0xca, 0x33, 0xaa, 0x04, 0x1b, 0x7d, 0xe8, 0x85, 0xe4, 0x56,
                0x6b, 0x6f, 0x44, 0x13, 0x80, 0x5b, 0x7e, 0x07, 0x9e, 0x15, 0x82, 0x19, 0x4f, 0x0f, 0xba, 0x67,
                0x4f, 0x44, 0x33, 0xbc, 0xf6, 0xb6, 0xdd, 0x75, 0x3a, 0xc0, 0x90, 0xd8, 0x0f, 0x6a, 0x02, 0x4c,
                0xa7, 0xdc, 0x91, 0x3d, 0x95, 0x51, 0xc3, 0xe2, 0xcf, 0xf3, 0x64, 0x93, 0x43, 0x17, 0x27, 0x49,
            };
        ...
        public void AES_OFB_256_Length16_NoPad()
        {
            var input = new byte[]
            {
                0x0c, 0x08, 0x74, 0x9d, 0x7c, 0xb3, 0xc7, 0xf0, 0xd3, 0xaf, 0x0f, 0x42, 0x0d, 0xee, 0xd7, 0x2e,
            };
            var key = new byte[]
            {
                0x2d, 0x58, 0xc7, 0x49, 0x0a, 0xe3, 0xc6, 0x85, 0x27, 0x79, 0x19, 0x99, 0xd0, 0x90, 0x48, 0xfa,
                0xea, 0x3d, 0xec, 0xd0, 0x6e, 0x1b, 0x66, 0xb2, 0x2c, 0x79, 0x16, 0x45, 0x6b, 0xaa, 0x76, 0xa3,
            };
            var iv = new byte[]
            {
                0x46, 0x1b, 0xb1, 0xf4, 0xa7, 0x4e, 0x9d, 0x28, 0x42, 0xee, 0x75, 0x02, 0x99, 0x2e, 0x20, 0x43,
            };

            // echo -n -e '\x0c\x08\x74\x9d\x7c\xb3\xc7\xf0\xd3\xaf\x0f\x42\x0d\xee\xd7\x2e' | openssl enc -e -aes-256-ofb -K 2D58C7490AE3C68527791999D09048FAEA3DECD06E1B66B22C7916456BAA76A3 -iv 461BB1F4A74E9D2842EE7502992E2043 -nopad | hd
            var expected = new byte[]
            {
                0xaa, 0xa2, 0x2a, 0x8e, 0xd2, 0x03, 0x23, 0x13, 0x7f, 0xd5, 0x8b, 0x95, 0x80, 0xc2, 0x8d, 0xf3,
            };
        ...
        public void AES_OFB_256_Length64_NoPad()
        {
            var input = new byte[]
            {
                0x66, 0x15, 0x57, 0xcf, 0x01, 0x06, 0xbf, 0x11, 0xf1, 0x15, 0x1c, 0x90, 0xcc, 0x80, 0x19, 0x7d,
                0x03, 0x76, 0x52, 0xb4, 0xde, 0x53, 0x52, 0x9c, 0xa0, 0xc4, 0x8e, 0x80, 0xa5, 0x64, 0x18, 0xfd,
                0x59, 0xd3, 0xde, 0x56, 0x52, 0xa7, 0xa1, 0x3f, 0x5b, 0xa0, 0x03, 0x92, 0x31, 0x0c, 0x5b, 0xc1,
                0xd4, 0xf8, 0xff, 0x23, 0xdb, 0x6b, 0x64, 0x13, 0xc2, 0xba, 0x2f, 0x3d, 0x78, 0x3f, 0x6b, 0x8c,
            };
            var key = new byte[]
            {
                0xfd, 0x1e, 0x37, 0xf9, 0xa1, 0xc3, 0x2b, 0x5b, 0xd4, 0x13, 0x58, 0x3e, 0x50, 0xc0, 0x6b, 0x93,
                0x68, 0xcc, 0xab, 0xad, 0x65, 0xf4, 0x21, 0xee, 0x6f, 0xcb, 0x93, 0x97, 0x78, 0x63, 0xc7, 0x1c,
            };
            var iv = new byte[]
            {
                0x34, 0x76, 0x95, 0x12, 0xd5, 0x62, 0x20, 0x11, 0xcd, 0xa3, 0x4e, 0xc8, 0x12, 0x26, 0xc2, 0x02,
            };

            // echo -n -e '' | openssl enc -e -aes-256-ofb -K FD1E37F9A1C32B5BD413583E50C06B9368CCABAD65F421EE6FCB93977863C71C -iv 34769512D5622011CDA34EC81226C202 -nopad | hd
            var expected = new byte[]
            {
                0x95, 0x4f, 0x8f, 0x25, 0x28, 0x5b, 0x5d, 0x15, 0xef, 0xad, 0x06, 0x1a, 0x77, 0xbc, 0xb9, 0x59,
                0x8b, 0x3f, 0xf6, 0x57, 0x39, 0x0b, 0xeb, 0x33, 0x5d, 0x1b, 0x63, 0x70, 0xf4, 0x14, 0x66, 0x47,
                0x89, 0x52, 0xb6, 0x25, 0x3d, 0xfe, 0xb9, 0x68, 0x2e, 0x92, 0xfd, 0x6d, 0x9b, 0x6a, 0x18, 0x8f,
                0x5e, 0x2e, 0x84, 0x3a, 0x3c, 0x0a, 0x45, 0xa2, 0x59, 0xe2, 0xa2, 0x53, 0x2b, 0xb9, 0x65, 0xe2,
            };
