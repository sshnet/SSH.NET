...
namespace Renci.SshNet.Tests.Classes.Security.Cryptography.Ciphers
{
    ...
    public class AesCipherTest : TestBase
    {
        ...
        public void Decrypt_Input_128_CTR()
        {
            ...
            var testCipher = new AesCipher(key, (byte[])iv.Clone(), AesCipherMode.CTR, false);
        ...
        public void AES_ECB_128_Length16()
        {
            ...
            var actual = new AesCipher(key).Encrypt(input);

            CollectionAssert.AreEqual(expected, actual);

            var decrypted = new AesCipher(key).Decrypt(actual);
