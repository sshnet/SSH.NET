...
#pragma warning restore S4158 // Empty collections should not be accessed or iterated
        ...
        public void GetBytes()
        {
            ...
            using (var sshDataStream = new SshDataStream(bytes))
            {
                ...
                Assert.AreEqual(actualOldPath.Length, sshDataStream.Read(actualOldPath, 0, actualOldPath.Length));
                ...
                Assert.AreEqual(actualNewPath.Length, sshDataStream.Read(actualNewPath, 0, actualNewPath.Length));
